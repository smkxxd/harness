...
Agent Harness v1 is ForgeTrace's current runtime shape: a local control loop around a model, code-aware repository context, constrained tools, task state, memory, and auditable run artifacts.
